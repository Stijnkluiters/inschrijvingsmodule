...
CREATE TABLE IF NOT EXISTS `inschrijfmodule`.`soort` (
  `soort_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `inschrijfmodule`.`evenement` (
  ...
  `hulpmiddelen` MEDIUMTEXT NULL,
  `soort_id` INT NOT NULL,
  `contactnr` INT NULL,
  `status` TINYINT(1) NULL DEFAULT 1,
  `publiek` TINYINT(1) NULL DEFAULT 0,
  PRIMARY KEY (`evenement_id`, `soort_id`),
...
CREATE INDEX `fk_evenement_soort1_idx` ON `inschrijfmodule`.`evenement` (`soort_id` ASC);
...
-- -----------------------------------------------------
-- Table `inschrijfmodule`.`branche`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inschrijfmodule`.`branche` ;

CREATE TABLE IF NOT EXISTS `inschrijfmodule`.`branche` (
  ...
  CONSTRAINT `fk_bedrijf_invertarisatie1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_branche_Bedrijf1`
...
CREATE INDEX `fk_bedrijf_invertarisatie1_idx` ON `inschrijfmodule`.`branche` (`inventarisatie_id` ASC);

CREATE INDEX `fk_branche_Bedrijf1_idx` ON `inschrijfmodule`.`branche` (`bedrijf_id` ASC);
...
CREATE TABLE IF NOT EXISTS `inschrijfmodule`.`contactpersoon` (
  ...
  CONSTRAINT `fk_contactpersoon_bedrijf1`
    ...
    REFERENCES `inschrijfmodule`.`branche` (`branche_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_contactpersoon_bedrijf1_idx` ON `inschrijfmodule`.`contactpersoon` (`branche_id` ASC);
...
CREATE INDEX `fk_vragenlijst_soort1_idx` ON `inschrijfmodule`.`vragenlijst` (`soort_id` ASC);
