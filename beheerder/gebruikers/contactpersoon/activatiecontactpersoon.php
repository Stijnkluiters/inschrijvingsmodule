...
<form action="<?= route('/index.php?gebruiker=activatiecontactpersoon&contact_id=' . $_GET['contact_id']) ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
